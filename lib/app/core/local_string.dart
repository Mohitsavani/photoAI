...
class Local extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_IN': {
          ...
          LocalString.english: "English",
          LocalString.hindi: "हिन्दी",
          LocalString.gujarati: "ગુજરાતી",
          LocalString.e: "E",
          LocalString.h: "ह",
          LocalString.g: "ગ",
        ...
        'hi_IN': {
          ...
          LocalString.pleaseWatchVideo:
              "कृपया इस पोस्टर को अनलॉक करने के लिए वीडियो देखें",
          LocalString.watch: "देखें",
          LocalString.removeWaterMark: "निशान हटाएं",
          LocalString.pleaseWatchVideoWaterMart:
              "वॉटरमार्क हटाने के लिए पूरा वीडियो विज्ञापन देखें।",
        ...
        'gu_IN': {
          ...
          LocalString.pleaseWatchVideo:
              "આ પોસ્ટરને અનલોક કરવા માટે કૃપા કરીને વીડિયો જુઓ",
          LocalString.watch: "જુઓ",
          LocalString.removeWaterMark: "વોટરમાર્ક દૂર કરો",
          LocalString.pleaseWatchVideoWaterMart:
              "વોટરમાર્ક દૂર કરવા માટે એક સંપૂર્ણ વિડિઓ જાહેરાત જુઓ.",

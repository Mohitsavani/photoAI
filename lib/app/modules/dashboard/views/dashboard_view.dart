...
import '../../../reusable/images/default_images.dart';
      ...
      bottomNavigationBar:IntrinsicHeight(
        child: Container(
          decoration: const BoxDecoration(
            border: Border(top: BorderSide(color: AppColors.xffB6B6B4,width: 0.5)),
          ),
          child:  Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration:  BoxDecoration(
                            color:index == controller.currentIndex.value? AppColors.appColor:AppColors.trans,
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: AppText(controller.dashBordItemList[index].title,style: index == controller.currentIndex.value?ubuntu.bold.appColor.get8:ubuntu.xffB6B6B4.get8),
                            )
                          ],
                        ),
                      ),
